...
namespace Geico_App
{
	...
	public class GeicoApp : AppModelBase
	{
		...
		{
			Name = @"GeicoApp";
			CertificateErrorNavigationBlockedPage = new CertificateErrorNavigationBlockedPageNode(contextTestObject, this);
			RebuildDescriptions();
		...
		public CertificateErrorNavigationBlockedPageNode CertificateErrorNavigationBlockedPage { get; private set; }
	
		#endregion
	
		#region Inner Classes
	
		public sealed class CertificateErrorNavigationBlockedPageNode : PageNodeBase
		{
			#region Constructors
		
			public CertificateErrorNavigationBlockedPageNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
			{
				ContinueToThisWebsiteNotRecommendedLink = new ContinueToThisWebsiteNotRecommendedLinkNode(this, applicationModel);
			...
			public ContinueToThisWebsiteNotRecommendedLinkNode ContinueToThisWebsiteNotRecommendedLink { get; private set; }
		
			#endregion
		
			#region Inner Classes
		
			public sealed class ContinueToThisWebsiteNotRecommendedLinkNode : LinkNodeBase
			{
				#region Constructors
			
				public ContinueToThisWebsiteNotRecommendedLinkNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
